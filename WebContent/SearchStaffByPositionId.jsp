		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="search_style">
					...
					<form action="SearchByStaffPos" method="get">
						...
						<ul class="search_content clearfix">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control"
									name="positionid" required="required" style="width: 50%"
					...
					<div class="Menu Manager_style">
						...
						<div class="table_menu_list">
							<table id="Menu_list" cellpadding="0" cellspacing="0"
								...
								<c:if test="${ not empty  posmsg}">
									<c:forEach var="pos" items="${posmsg}">
										<tbody>



											<tr>
												<td>${pos.staffnumber }</td>
												<td>${pos.staffname }</td>
												<td>${pos.stafftel }</td>
												<td>${pos.staffemail }</td>
												<td>${pos.dep.departmentname }</td>
												<td>${pos.pos.positionname }</td>
												<td>${pos.workingstate }</td>
