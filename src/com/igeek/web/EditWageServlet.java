...
@WebServlet("/editwage")
public class EditWageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String sid=req.getParameter("wageid");
		int wageid=Integer.parseInt(sid);
		//调用业务 找到要修改的工资信息
		Wage wage=service.searchWageBywageid(wageid);
		//将找到的工资信息存入作用域
		req.setAttribute("edit", wage);
		
		//转发到修改页面
		req.getRequestDispatcher("/editwage.jsp").forward(req, resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//设置请求编码
				...
				//接受修改后的参数
				String wageid=req.getParameter("wageid");
				...
				//封装
				Wage wage=new Wage();
				wage.setWageid(Integer.parseInt(wageid));
