...
@WebServlet("/ContractInsertWeb")
public class ContractInsertWeb extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int a=ts.insertContract(Integer.parseInt(value1),value2,value3,value4,value5);							
		if(a>0) {			
